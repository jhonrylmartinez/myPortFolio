        ...
        <div className="mt-12 flex justify-evenly space-x-8">
          ...
          <div className="text-center">
            <img
              ...
              className="w-60 h-60 rounded-full border-4 border-green-500 shadow-xl object-cover transition-transform transform hover:scale-110"
            />
          ...
          <div className="text-center">
            <img
              ...
              className="w-60 h-60 border-4 border-green-500 rounded-full shadow-xl object-cover transition-transform transform hover:scale-110"
            />
